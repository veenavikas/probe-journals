...
CREATE TABLE `journals` (
  ...
  `acceptance_rate` decimal(5,2) DEFAULT 28.41,
  `rejection_rate` decimal(5,2) DEFAULT 40.89,
  `submitted_rate` decimal(5,2) DEFAULT 30.70,
  PRIMARY KEY (`id`),
